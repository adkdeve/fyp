            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    // Tab Content
                    Obx(() => controller.activeTab.value == 'terms'
                        ? _buildTermsContent()
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTermsSection(
            ...
            content: 'By accessing and using the AI Construction Site Safety Monitor application ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these terms, please do not use the Service.',
          ),
          const SizedBox(height: 20),
          _buildTermsSection(
            title: '2. Use License',
            content: 'Permission is granted to use the Service for construction site safety monitoring purposes under the following conditions:',
            bulletPoints: [
          ...
          _buildTermsSection(
            ...
            content: 'While our AI-powered detection system achieves high accuracy rates (90%+), it should not replace human supervision and judgment. The Service is designed to assist safety monitoring, not replace comprehensive safety protocols. Users are responsible for verifying all violations and taking appropriate action.',
          ),
          const SizedBox(height: 20),
          _buildTermsSection(
            title: '4. Data Collection and Camera Use',
            content: 'You agree that the Service will collect video footage and safety violation data from construction sites. All parties working on monitored sites must be informed of camera surveillance and AI monitoring in compliance with local privacy laws.',
          ),
          const SizedBox(height: 20),
          _buildTermsSection(
            title: '5. Limitation of Liability',
            content: 'The Service providers shall not be held liable for any incidents, accidents, or safety violations that occur despite the use of the monitoring system. The Service is a tool to enhance safety, not guarantee it.',
          ),
          const SizedBox(height: 20),
          _buildTermsSection(
            title: '6. Service Modifications',
            content: 'We reserve the right to modify or discontinue the Service at any time without notice. We may also update these terms periodically, and continued use of the Service constitutes acceptance of modified terms.',
          ),
          const SizedBox(height: 20),
          _buildTermsSection(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildPrivacySection(
            ...
            content: 'Violation records and video footage are retained for a minimum of 90 days and up to 7 years depending on regulatory requirements and your subscription plan. You can request data deletion at any time, subject to legal obligations.',
          ),
          const SizedBox(height: 20),
          _buildPrivacySection(
          ...
          _buildPrivacySection(
            ...
            content: 'We use minimal tracking technologies to improve app performance and user experience. You can manage cookie preferences in your device settings.',
          ),
          const SizedBox(height: 20),
          _buildPrivacySection(
            title: '8. Contact Us',
