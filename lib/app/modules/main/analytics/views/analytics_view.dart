...
class AnalyticsView extends GetView<AnalyticsController> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Obx(() => Text(
                '${controller.timeRange.value == "week" ? "Weekly" : controller.timeRange.value == "month" ? "Monthly" : "Yearly"} Violations',
                style: const TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                ...
                titlesData: FlTitlesData(
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      showTitles: true,
                      getTitlesWidget: (value, meta) {
                        if (value.toInt() < controller.complianceTrend.length) {
                          return Text(
  ...
  Widget _buildZonePerformance(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width - 64; // Calculate available width
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          _buildAIMetric('Detection Accuracy', '94%', 0.94, Colors.blue, screenWidth),
          const SizedBox(height: 16),
          _buildAIMetric('False Positive Rate', '6%', 0.06, Colors.orange, screenWidth),
          const SizedBox(height: 16),
          _buildAIMetric('Processing Speed', '30 FPS', 1.0, Colors.green, screenWidth),
        ],
      ),
    );
  }
  ...
  Widget _buildAIMetric(String label, String value, double percentage, Color color, double screenWidth) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
